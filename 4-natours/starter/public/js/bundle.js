...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extend map bounds
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            console.log("login was called, about to login.. email: ".concat(email, ", password: ").concat(password));
            _context.prev = 1;
            _context.next = 4;
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Login sucess');
          ...
          case 9:
            ...
            if (_context.t0.response.data) {
              ...
              (0, _alerts.showAlert)('error', 'There was an error, try again later..');
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logout sucess');
              window.setTimeout(function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            //   alert(email, password);
            console.log("updateSettings called, about to upodate user data: ".concat(JSON.stringify(data)));
          ...
          case 6:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Details updated');
              window.setTimeout(function () {
                location.reload();
              }, 1500);
            }
...
var updateSettingsSubmit = document.querySelector('.form-user-data');
var userPasswordForma = document.querySelector('.form-user-settings');
...
if (loginForm) {
  ...
  loginForm.addEventListener('submit', function (e) {
    ...
    console.log("Submit button clicked: email: ".concat(email, ", password: ").concat(password));
...
if (userPasswordForma) {
  ...
  userPasswordForma.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              console.log("Submit password clicked: oldPassword: ".concat(oldPassword, ", newPassword: ").concat(newPassword, ", confirmPassword: ").concat(confirmPassword));
              _context.next = 9;
